...
alias .="nvim ."
alias fix="$HOME/scripts/fix-git.sh"
alias pacman="sudo pacman --noconfirm"
alias anime="ani-cli"
alias update="$HOME/scripts/sysup.sh"
alias gpatch="git apply --ignore-space-change --ignore-whitespace --3way"
alias yay="yay --noconfirm"
# alias fzf='fzf --preview "bat --color=always {}" | xargs nvim'
alias b="bat"
alias clear-ram="sudo $HOME/scripts/clear-ram.sh"
alias adb="$HOME/Downloads/platform-tools/adb"
alias tmuxconf="nvim $HOME/.tmux.conf"
alias anime="ani-cli"
alias work-login="
gh auth logout
git config --global user.name 'urizenfonu'
git config --global user.email 'victor@fonu.com'
gh auth login
"
alias work-logout="
gh auth logout
...
alias del="trash-put"
alias media="ssh root@193.46.243.26"
alias fonu-api="ssh root@194.5.152.212"
alias sbc="ssh root@193.46.243.218"
alias auth="ssh root@194.5.152.119"
alias lzd="_ lazydocker"
