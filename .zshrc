...
plugins=(git zsh-autosuggestions zsh-syntax-highlighting zsh-completions archlinux  gh  golang npm nvm rust tmux zoxide zsh-interactive-cd  git-auto-fetch fzf-tab)
